    ...
    return (
      <section>
        ...
        <form id="signUp-form" onSubmit={(e) => this.submitSignUpForm(e)}>
          ...
          <button type="submit" className="btn cancel-btn" onClick={(e) => this.cancelSignUp(e)}>Cancel</button>
        </form>
        ...
        <form id="signIn-form" onSubmit={(e) => this.submitSignInForm(e)}>
          ...
          <button type="submit" className="btn cancel-btn" onClick={(e) => this.cancelSignIn(e)}>Cancel</button>
        </form>
      </section>
    );
  }
